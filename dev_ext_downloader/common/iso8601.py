...
def parse_iso8601(s: str, default_tz: str | pytz.BaseTzInfo = "UTC") -> datetime:
    s = s.replace("Z", "+00:00")
    try:
...
def _get_tz(tz: str | pytz.BaseTzInfo) -> pytz.BaseTzInfo:
...
def format_datetime(
    dt: datetime,
    target_tz: str | pytz.BaseTzInfo = "UTC",
...
def convert_tz(
    dt: datetime,
    from_tz: str | pytz.BaseTzInfo,
    to_tz: str | pytz.BaseTzInfo,
) -> datetime:
